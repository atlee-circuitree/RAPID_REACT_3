...
robotDistance[27] = new LaunchVelocity(6200, 9600);
robotDistance[28] = new LaunchVelocity(6700, 9300);
robotDistance[29] = new LaunchVelocity(7200, 8800);
...
robotDistance[35] = new LaunchVelocity(9200, 8000);
...
robotDistance[39] = new LaunchVelocity(10500, 7900);
robotDistance[40] = new LaunchVelocity(11200, 7800);
robotDistance[41] = new LaunchVelocity(11400, 7700);
robotDistance[42] = new LaunchVelocity(11600, 7600);
robotDistance[43] = new LaunchVelocity(12500, 7000);
